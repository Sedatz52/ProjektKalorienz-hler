...
//                var iclikofte = new Model.Produkt { Name = "Icli Köfte", Kalorien = 250, Gramm = 100 };
...
//                db.Produkte.AddRange(dolma, sarma, lahmacun, iclikofte, menemen, künefe);
//                db.SaveChanges();
...
//                        var menge = db.Produkte.FirstOrDefault(p => p.Id == verbrauchHeute.Id);

//                        // Zeigen Sie den Überblick über das Essen mit Produktinformationen an
//                        Console.WriteLine($"{verbrauchHeute.Zeitpunkt.ToShortTimeString()} - {produkt.Name} ({verbrauchHeute.Menge} Gramm)");
//                    }
